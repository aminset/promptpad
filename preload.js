...
contextBridge.exposeInMainWorld('api', {
  ...
  improvePrompt: (text, apiKey, provider) => ipcRenderer.invoke('improve-prompt', { text, apiKey, provider }),
  aiTransform: (action, text, apiKey, provider) => ipcRenderer.invoke('ai-transform', { action, text, apiKey, provider }),
  chatMessage: (history, apiKey, provider) => ipcRenderer.invoke('chat-message', { history, apiKey, provider }),
